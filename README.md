...
Mostly focused on database, immutable record, index, view, cache, and distributed systems.
...
- [A makefile tutorial by Isaac Schlueter](https://gist.github.com/isaacs/62a2d1825d04437c6f08)

## Bookkeeping

- [Minimum Viable Block Chain - A blog post by Ilya Grigorik](https://www.igvita.com/2014/05/05/minimum-viable-block-chain/)

## CDN and Cache

- [Leveraging your CDN to cache "uncacheable" content - A blog post by Hooman Beheshti](https://www.fastly.com/blog/caching-dynamic-content)
...
- [The Super Tiny Compiler - A tutorial by James Kyle](https://github.com/thejameskyle/the-super-tiny-compiler)

## Concurrency

- [Concurrency is not parallelism - A talk by Rob Pike](https://blog.golang.org/concurrency-is-not-parallelism)
- [Locks, Actors, And Stm In Pictures - A blog post by Aditya Bhargava](http://adit.io/posts/2013-05-15-Locks,-Actors,-And-STM-In-Pictures.html)
- [The Dining Philosophers Problem With Ron Swanson - A blog post by Aditya Bhargava](http://adit.io/posts/2013-05-11-The-Dining-Philosophers-Problem-With-Ron-Swanson.html)

## Database

- [Turning the database inside-out with Apache Samza - A talk by Martin Kleppmann](https://www.confluent.io/blog/turning-the-database-inside-out-with-apache-samza/)
- [Replicated Data Consistency Explained Through Baseball - A technical report by Doug Terry](https://www.microsoft.com/en-us/research/publication/replicated-data-consistency-explained-through-baseball/)
...
- [Functors, Applicatives, And Monads In Pictures - A blog post by Aditya Bhargava](http://adit.io/posts/2013-04-17-functors,_applicatives,_and_monads_in_pictures.html)
...
- [Unix Philosophy and Node.js - A blog post by Isaac Schlueter](http://blog.izs.me/post/48281998870/unix-philosophy-and-nodejs)
- [誰得の100徳ナイフを買ったというお話 - A blog post by 深津貴之](http://fladdict.net/blog/2013/08/something-bout-giant-knife.html)
...
- [WTFPL - A software license](http://www.wtfpl.net/about/)

## Statistics

- [How Not To Run An A/B Test - A blog post by Evan Miller](http://www.evanmiller.org/how-not-to-run-an-ab-test.html)
- [Simple Sequential A/B Testing - A blog post by Evan Miller](http://www.evanmiller.org/sequential-ab-testing.html)

## Publishing

- [Subcompact Publishing - An essay by Craig Mod](http://craigmod.com/journal/subcompact_publishing/)
- [「超小型」出版 - クレイグ・モド氏による出版物の未来予想](http://craigmod.com/journal/subcompact_publishing/ja/)

## Versioning

- [On Versioning - A blog post by Niels Rosen Abildgaard](http://blog.hypesystem.dk/on-versioning)
- [Spec-ulation Keynote - A YouTube video by Rich Hickey](https://www.youtube.com/watch?v=oyLBGkS5ICk)
